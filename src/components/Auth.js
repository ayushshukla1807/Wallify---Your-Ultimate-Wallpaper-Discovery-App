    ...
    return (
        <div className="signup-outer">
            <div className="signup-container">
                <div className={`signup-left ${isLogin ? 'login-left' : ''}`}>
                    <div className="signup-logo">WALLIFY</div>
                    <div className={`signup-image-bg ${isLogin ? 'login-image-bg' : ''}`}>
                ...
                <div className="signup-right">
                    ...
                    <p className="signup-login-link">
                        ...
                        <button type="button" className="terms-link" onClick={toggleMode}>
                    ...
                    <form className="signup-form" onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className={`signup-btn ${isLogin ? 'login-btn' : ''}`}>
